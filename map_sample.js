        var map = L.map('map').setView([35.726893, 139.717011], 17);
        ...
        var marker;
        marker = L.marker([35.726893, 139.717011]).addTo(map)
            .bindPopup('【使い方】<br/><font size="18px" color="#E4007F">●</font><font size="10px">をタップで<br>情報表示</font>')
            .openPopup();
